...
export default function Page() {
    ...
    () => [
      {
        ...
        items: [
          ...
          <>
            ...
            <code className="bg-accent/20 font-mono px-1 py-0.5 rounded-md">
  ...
  return (
    <div className="p-10 h-full w-full">
      ...
      >
        <p>
          Python RPA enables orchestration of Python scripts (bots). The
          platform support both Python code based scripts (bots) orchestration
          as well as bots build using Low-code Studio.
        </p>

        <p>
          Below you can find an instruction on how to connect Python
          scripts(bots) to Orchestrator.
        </p>
